...
const testGreetUser = greetUser(`Mike`);
console.log(testGreetUser);
...
const testZipTrue = canWeDeliver(85205);
console.log(testZipTrue);
const testZipFalse = canWeDeliver(43119);
console.log(testZipFalse);
/* 
    Problem 2 Continued
...
const testZipTrue2 = canWeDeliverTwo(85205);
console.log(testZipTrue2);
const testZipFalse2 = canWeDeliverTwo(43119);
console.log(testZipFalse2);
//////////////////PROBLEM 3////////////////////
/* 
